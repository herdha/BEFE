...
// fetch data
newDashStore.fetchDataVehicle()

// highchart
const data = computed(()=>{ return newDashStore.getDataVehicle}) 
const option = ()=>{
...
// apex
// const series = computed(()=>{ return newDashStore.getDataVehicleApex.total}) /** access getter data series */
// const setConf = computed(() => {
//     const config = getDonutChartConfig(vuetifyTheme.current.value)
//     config.labels = newDashStore.getDataVehicleApex.title /** access getter data label */
...
const updateChart = async()=>{
    // get data to update
    series.value = await newDashStore.getDataVehicleApex.total
    optionConfig.value.labels = await newDashStore.getDataVehicleApex.title
