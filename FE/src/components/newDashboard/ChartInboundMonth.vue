...
// fetch data
newDashStore.fetchInboundMonth()

// highchart
const dataSeries = computed(()=>{ return newDashStore.getDataInboundMonth.series})
const dataCategories = computed(()=>{ return newDashStore.getDataInboundMonth.categories})
const setOption = ()=>{
...
// apex
// const series = computed(()=>{ return newDashStore.getDataInboundMonth.series})
// const chartConfig = computed(() => {
//     const config = getColumnChartConfig(vuetifyTheme.current.value)
//     config.xaxis.categories = newDashStore.getDataInboundMonth.categories
...
delete optionConfig.value.plotOptions.bar.colors

// function to update chart
const updateChart = async()=>{
    // get series to update
    series.value = await newDashStore.getDataInboundMonth.series
    // set new series
    const newSeries = [
    ...
    xaxis.categories = await newDashStore.getDataInboundMonth.categories
