...
export const getInboundWeekReceiveConfig = (themeColors, xLabel) => {
    const columnColors = {
        series1: '#5CACC4',
        series2: '#83D3E0',
        bg: '#f2f2f2',
...
export const getInboundWeekUnpackingConfig = (themeColors, xLabel) => {
    const columnColors = {
        series1: '#5CACC4',
        series2: '#83D3E0',
        bg: '#f2f2f2',
...
export const getInboundWeekPutawayConfig = (themeColors, xLabel) => {
    const columnColors = {
        series1: '#5CACC4',
        series2: '#83D3E0',
        bg: '#f2f2f2',
